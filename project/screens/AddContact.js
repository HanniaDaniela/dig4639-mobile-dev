  ...
  render () {
    return (
      <>
        ...
        <Button title='Add Contact' buttonStyle={{ backgroundColor: '#f59d92' }} onPress={() => this.add()} disabled={this.state.submitDisabled} />
        <Button title='Back' buttonStyle={{ backgroundColor: 'lightblue' }} onPress={() => this.props.navigation.navigate("home")} />
      </>
    )
  }
}
